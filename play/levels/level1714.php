...
<body style="font-family: 'Lato', sans-serif; font-size:1.7em;">
	...
	<div class="container" style="max-width:800px; margin-top:40px ">
     ...
     <h2 class="text-center">Level-14</h2>       <br>

       <div class="row">
		<div class="col-sm-6" style="padding:40px">
			<img src="images/level14/16924164_10208547357541288_1415671979_n.jpg" class="img-rounded img-responsive" style="width:350px;height:240px">
	     </div>
		<div class="col-sm-6">
			<img src="images/level14/medicines.jpg" class="img-rounded img-responsive" style="width:350px;height:300px">
		</div>
	    </div>	
