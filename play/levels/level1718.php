...
<body style="font-family: 'Lato', sans-serif; font-size:1.7em;">
	...
	<div class="container" style="max-width:1200px; margin-top:40px ">
     ...
     <h2 class="text-center">ONE foot cannot stand on two boats</h2>       <br>

       <div class="row">
		<div class="col-sm-4">
			<img src="images/level18/16E9.png" class="img-rounded img-responsive">
	     </div>
		<div class="col-sm-4">
			<img src="images/level18/or.png" class="img-rounded img-responsive">
		</div>
                <div class="col-sm-4">
			<img src="images/level18/honeysingh.png" class="img-rounded img-responsive">
		</div>
	    </div>	
