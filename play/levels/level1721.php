...
<body style="font-family: 'Lato', sans-serif; font-size:1.7em;">
	...
	<div class="container" style="max-width:700px; margin-top:40px ">
     ...
     <h2 class="text-center">Can we do it?</h2>       <br>

       <div class="row">
		<div class="col-sm-4">
			<img src="images/level21/baseball.jpg" class="img-rounded img-responsive">
	     </div>
		<div class="col-sm-4">
			<img src="images/level21/cricket.jpg" class="img-rounded img-responsive">
		</div>
                <div class="col-sm-4">
			<img src="images/level21/LEVEL2ONE.jpg" class="img-rounded img-responsive">
		</div>
	    </div>	
