...
<body style="font-family: 'Lato', sans-serif; font-size:1.7em;">
	...
	<div class="container" style="max-width:700px; margin-top:40px ">
     ...
     <h2 class="text-center">Can you unZIP me?</h2>       <br>

       <div class="row">
		<div class="col-sm-6">
			<img src="images/level11/11.png" class="img-rounded img-responsive">
	     </div>
		<div class="col-sm-6">
			<img src="images/level11/iHopeYouStillRememberMe.png" class="img-rounded img-responsive">
		</div>
	    </div>	
