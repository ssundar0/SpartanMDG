...
<body style="font-family: 'Lato', sans-serif; font-size:1.7em;">
	...
	<div class="container" style="max-width:700px; margin-top:40px ">
     ...
     <h2 class="text-center">Anagram</h2>       <br>

       <div class="row">
		<div class="col-sm-4">
			<img src="images/level17/sEveNtEeN_1.png" class="img-rounded img-responsive">
	     </div>
		<div class="col-sm-4">
			<img src="images/level17/sEveNtEeN_2.jpg" class="img-rounded img-responsive">
		</div>
                <div class="col-sm-4">
			<img src="images/level17/strategy.png" class="img-rounded img-responsive">
		</div>
	    </div>

                <div class="row">
		<div class="col-sm-4">
			<img src="images/level17/sEveNtEeN_3.jpg" class="img-rounded img-responsive">
	     </div>
		<div class="col-sm-4">
			<img src="images/level17/sEveNtEeN_4.jpg" class="img-rounded img-responsive">
		</div>
                <div class="col-sm-4">
			<img src="images/level17/level17_6.jpg" class="img-rounded img-responsive">
		</div>
	    </div>	
