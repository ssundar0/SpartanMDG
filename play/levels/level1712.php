...
<h2 class="text-center">Level-12</h2>
<br>

  <div class="row" style="padding-top:60px">
 <div class="text-center">
      <audio controls class="img-rounded col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1 " style="border-style:solid; border-color:rgba(255,255,255,0.2); border-width:15px;padding:0;border-radius: 0px;">
      
        <source src="images/level12/leveltwelve.ogg" type="audio/ogg">
        <source src="images/level12/leveltwelve.mp3" type="audio/mpeg">
